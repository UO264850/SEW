...
class ClaculadoraFinanciera extends CalculadoraRPN{
    constructor(){
        super();
    }

    capitalReunido(){
        var n = this.pop(); //tiempo
        this.write("100");
        this.push();
        this.division();
        //interes en pila
    ...
    interesFinal(){
        //capital reunido y capital invertido en pila
        this.resta();
        this.write("100");
        this.push();
        this.multiplicacion();
    ...
    capitalObtenido(){
        ...
        var Cn = this.pop(); //capital reunido
        ...
        var R = Math.round(this.pop()); // retencion Final
